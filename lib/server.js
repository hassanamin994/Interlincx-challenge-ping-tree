...
var targetsController = require('./controllers/targets');
...
router.set('/api/targets', { POST: targetsController.addTarget, GET: targetsController.getAllTargets })
router.set('/api/targets/:id', { GET: targetsController.getTargetById, POST: targetsController.updateTargetById })
router.set('/route', { POST: routeController.getUsableTarget })
